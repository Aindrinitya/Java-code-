...
<button onclick="showSection('librarySection')">
Library Books
</button>

<button onclick="showSection('issueSection')">
Issue Book
</button>

<button onclick="showSection('returnSection')">
Return Book
</button>
...
let book = books[(i-1)%books.length];
...
row.insertCell(3).innerHTML = issueDate;
row.insertCell(4).innerHTML = finalReturnDate;
...
.innerHTML="<h3>No Record Found</h3>";
